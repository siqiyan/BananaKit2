...
![weather_module](/doc/weather_module.jpg)

The wiring is shown in the blueprint below. One thing that gives me trouble was
that the CCS811 sensor needs to ground the WAKE pin before it can read data,
and I wasted a lot of time to figure out.

![weather_module_blueprint](/doc/weather_module_blueprint.png)
